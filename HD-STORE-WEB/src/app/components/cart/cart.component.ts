...
export class CartComponent implements OnInit{
  ...
  // isChecked: boolean = this.apiCart.ischecked;
  ...
  minusQty(id:number, pro_price:any){
  ...
  checkAll(){
    // if(this.lstCartOrder < this.lstCart){
    //   const formData = new FormData();
    //   const id = 0;
    //   formData.append('id', id.toString());
    //   this.apiCart.setIsCheck(formData).subscribe();
    //   this.getCart(this.cartID);
    //   this.isChecked = this.apiCart.setFalse();
    // }
    // else{
    //   const formData = new FormData();
    //   const id = 0;
    ...
    //   this.apiCart.setIsCheck(formData).subscribe();
    //   this.getCart(this.cartID);
    //   this.isChecked = this.apiCart.setTrue();
    // }
  }
